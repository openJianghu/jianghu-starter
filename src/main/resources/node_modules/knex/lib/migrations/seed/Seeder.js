...
const { ensureDirectoryExists, getFilepathsInFolder } = require('knexNode/lib/migrations/util/fs');
const { writeJsFileUsingTemplate } = require('knexNode/lib/migrations/util/template');
const { yyyymmddhhmmss } = require('knexNode/lib/migrations/util/timestamp');
...
class Seeder {
  ...
  async _validateSeedStructure(filepath) {
    const importFile = require('knexNode/lib/migrations/util/import-file'); // late import
