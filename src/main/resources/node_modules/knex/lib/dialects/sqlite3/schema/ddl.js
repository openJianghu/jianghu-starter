...
const { nanonum } = require('knexNode/lib/util/nanoid');
const {
  createNewTable,
  copyData,
  dropOriginal,
  renameTable,
  getTableSql,
} = require('knexNode/lib/dialects/sqlite3/schema/internal/sqlite-ddl-operations');
const { parseCreateTable, parseCreateIndex } = require('knexNode/lib/dialects/sqlite3/schema/internal/parser');
const {
  compileCreateTable,
  compileCreateIndex,
} = require('knexNode/lib/dialects/sqlite3/schema/internal/compiler');
const { isEqualId, includesId } = require('knexNode/lib/dialects/sqlite3/schema/internal/utils');
