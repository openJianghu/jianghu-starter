...
const Transaction = require('knexNode/lib/dialects/sqlite3/execution/sqlite-transaction');
const SqliteQueryCompiler = require('knexNode/lib/dialects/sqlite3/query/sqlite-querycompiler');
const SchemaCompiler = require('knexNode/lib/dialects/sqlite3/schema/sqlite-compiler');
const ColumnCompiler = require('knexNode/lib/dialects/sqlite3/schema/sqlite-columncompiler');
const TableCompiler = require('knexNode/lib/dialects/sqlite3/schema/sqlite-tablecompiler');
const ViewCompiler = require('knexNode/lib/dialects/sqlite3/schema/sqlite-viewcompiler');
const SQLite3_DDL = require('knexNode/lib/dialects/sqlite3/schema/ddl');
