...
const Oracle_Compiler = require('knexNode/lib/dialects/oracle/query/oracle-querycompiler');
const ReturningHelper = require('knexNode/lib/dialects/oracledb/utils').ReturningHelper;
const BlobHelper = require('knexNode/lib/dialects/oracledb/utils').BlobHelper;
