...
const cliPkg = require('knexNode/package.json');
const {
  mkConfigObj,
  ...
  findUpModulePath,
  findUpConfig,
} = require('knexNode/bin/utils/cli-config-utils');
const {
  existsSync,
  readFile,
  writeFile,
} = require('knexNode/lib/migrations/util/fs');

const { listMigrations } = require('knexNode/bin/utils/migrationsLister');

async function openKnexfile(configPath) {
  const importFile = require('knexNode/lib/migrations/util/import-file'); // require me late!
