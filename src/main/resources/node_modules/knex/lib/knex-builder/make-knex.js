...
const { Migrator } = require('knexNode/lib/migrations/migrate/Migrator');
const Seeder = require('knexNode/lib/migrations/seed/Seeder');
const FunctionHelper = require('knexNode/lib/knex-builder/FunctionHelper');
const QueryInterface = require('knexNode/lib/query/method-constants');
const merge = require('lodash/merge');
const batchInsert = require('knexNode/lib/execution/batch-insert');
const { isObject } = require('knexNode/lib/util/is');
