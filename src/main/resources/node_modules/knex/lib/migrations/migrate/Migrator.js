...
const {
  ...
  getTable,
  getTableName,
} = require('knexNode/lib/migrations/migrate/table-resolver');
const { getSchemaBuilder } = require('knexNode/lib/migrations/migrate/table-creator');
const migrationListResolver = require('knexNode/lib/migrations/migrate/migration-list-resolver');
const MigrationGenerator = require('knexNode/lib/migrations/migrate/MigrationGenerator');
const { getMergedConfig } = require('knexNode/lib/migrations/migrate/configuration-merger');
const { isBoolean, isFunction } = require('knexNode/lib/util/is');
